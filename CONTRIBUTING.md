...
open-source project. Please read [`LICENSE`](LICENSE) before contributing;
§5 governs contributions specifically. The summary below is plain English, and
...
PRs are welcome, and are governed by **§5 of the LICENSE** — read it first, since
it sets out what happens to the rights in anything you submit.
