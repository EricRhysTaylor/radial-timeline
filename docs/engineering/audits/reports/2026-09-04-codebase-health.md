...
- **Follow-up (2026-09-05):** the black halos are gone entirely, not converted. The owner never wanted the black flood the old filters painted behind hovered scene and beat titles, and the stroke that replaced it rendered heavier than the filter had. Scene titles carry no `rt-selected` styling now, beat titles keep only the bold weight and fill change, and the hovered scene path has no edge. The hovered scene is announced by its title and synopsis.
