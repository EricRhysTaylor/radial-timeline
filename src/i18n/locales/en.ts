    ...
    settings: {
        ...
        inquiry: {
            ...
            prompts: {
                ...
                unlockProGhost: 'More custom question slots open when Pro mode is on (Settings → Pro)',
        ...
        authorProgress: {
            ...
            publishing: {
                ...
                proTeaser: {
                    ...
                    enhanceWorkflow: 'Turn on Pro mode',
                    desc: 'Campaign manager lets you create multiple embeds with Teaser Reveal\u2014progressively show more detail as you write. It sits with the other Pro mode workflows, alongside runtime (RT) chronologue mode and advanced Pandoc publishing templates. All of it ships with the plugin at no cost.',
