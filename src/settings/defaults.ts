...
export const DEFAULT_SETTINGS: RadialTimelineSettings = {
    ...
    enableAiSceneAnalysis: false, // AI ships OFF: no AI connection until the writer opts in AND configures a provider (owner decision 2026-07-16; existing users keep their persisted choice)
