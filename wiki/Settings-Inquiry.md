...
*   **Built-in questions**: Each zone (Setup, Pressure, Payoff) ships with 4 core questions; Pro adds 5 more per zone, for 9 built-in questions per zone.
*   **Custom questions**: Add and reorder your own prompts per zone on top of the built-ins. The Core surface allows 3 custom questions per zone; Pro raises the limit to 8.
